...
⚠️ 注意：如果已经安装了原版插件请先禁用或卸载，否则会冲突导致无法正常使用！⚠️
...
> [!IMPORTANT]
>
> **请仅在网络良好（`raw.githubusercontent.com` 能正常访问）的情况下使用此方法。**
>
> 检查方法：命令行执行
>
> ```shell
...
>
> Thanks to [@key-moon](https://github.com/key-moon) for the [original script](https://github.com/key-moon/ac-predictor/tree/master/addon) (Japanese).
